...
public class LonginDTO {
    ...
    public LonginDTO withFoo(String foo) {
        this.foo = foo;
        return this;
    }
    ...
    public LonginDTO withBar(Integer bar) {
        this.bar = bar;
        return this;
    }
    ...
    public LonginDTO withBaz(Boolean baz) {
        this.baz = baz;
        return this;
    }
    ...
    public LonginDTO withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LonginDTO) == false) {
            return false;
        }
        LonginDTO rhs = ((LonginDTO) other);
