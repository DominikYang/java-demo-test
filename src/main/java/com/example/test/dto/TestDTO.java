...
public class TestDTO {
    ...
    public TestDTO withFoo(String foo) {
        this.foo = foo;
        return this;
    }
    ...
    public TestDTO withBar(Integer bar) {
        this.bar = bar;
        return this;
    }
    ...
    public TestDTO withBaz(Boolean baz) {
        this.baz = baz;
        return this;
    }
    ...
    public TestDTO withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TestDTO) == false) {
            return false;
        }
        TestDTO rhs = ((TestDTO) other);
