...
public class TestVO {
    ...
    public TestVO withFoo(String foo) {
        this.foo = foo;
        return this;
    }
    ...
    public TestVO withBar(Integer bar) {
        this.bar = bar;
        return this;
    }
    ...
    public TestVO withBaz(Boolean baz) {
        this.baz = baz;
        return this;
    }
    ...
    public TestVO withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TestVO) == false) {
            return false;
        }
        TestVO rhs = ((TestVO) other);
